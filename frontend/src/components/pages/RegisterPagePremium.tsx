...
import { PremiumInput, PremiumCheckbox } from '@/design-system/components/premium-input';
import { PremiumCard, CardContent } from '@/design-system/components/premium-card';
import { Reveal } from '@/design-system/components/motion';
    ...
    <Layout>
      <div className="min-h-[80vh] flex items-center justify-center px-4 py-16">
        <div className="w-full max-w-md">
          <Reveal animation="fade" duration="slow">
            {/* Header */}
            <div className="text-center mb-10">
              ...
              <p className="text-muted-foreground">
                Join Vibe Basket for a premium shopping experience
              </p>
            </div>
          </Reveal>

          <Reveal animation="slide-up" delay={100}>
            <PremiumCard variant="elevated" padding="lg" radius="xl" className="backdrop-blur-sm">
              <CardContent>
                    ...
                    <div className="space-y-2 pl-1">
                      {passwordChecks.map((check, index) => (
                        ...
                        >
                          ...
                          >
                            <Check className={cn(
                              'w-2.5 h-2.5 text-white transition-opacity duration-200',
                              check.valid ? 'opacity-100' : 'opacity-0'
                            )} />
                          </div>
                          {check.label}
                        </div>
